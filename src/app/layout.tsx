...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="bg-gradient-to-r from-sky-500 to-indigo-500 ">
      ...
      <body className={inter.className} >
        ...
        <header className="flex items-center text-white bg-gradient-to-r from-sky-500 to-indigo-500 justify-center">
          <div className='absolute left-0 mx-3 pb-10'>
              <button
                type="button"
